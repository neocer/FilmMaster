...
public class SearchfromOK implements Searchfilm
{
    public static String Link = "http://www.okzy.me";
    @Override
    public Searchresult[] Searchbykey(String key)
    {
        Searchresult[] x = new Searchresult[0];
        String text = mytool.MyRequest.sendPost("http://www.okzy.me/index.php?m=vod-search","wd="+key+"&submit=search");
