...
public class Seachfrom131 implements Searchfilm
{

    public static String Link = "http://131zy.vip";
    @Override
    public Searchresult[] Searchbykey(String key)
    {
       Searchresult[] x = new Searchresult[0];
       String text = mytool.MyRequest.sendPost("http://131zy.vip/index.php?m=vod-search","wd="+key+"&submit=search");
